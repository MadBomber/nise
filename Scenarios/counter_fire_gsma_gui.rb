...
blue_launchers << { :name => "cf_launcher_01", :position => [37.23796232773378, 126.9975666493282, 0.0] }
blue_launchers << { :name => "cf_launcher_02", :position => [37.23949057276692, 126.9981968541871, 0.0] }
blue_launchers << { :name => "cf_Launcher_03", :position => [37.81265882971723, 126.8774007941036, 0.0] }
