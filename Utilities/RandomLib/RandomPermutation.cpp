...
namespace {
  char rcsid[] = "$Id: RandomPermutation.cpp 6412 2008-01-06 22:43:14Z ckarney $";
}
...
int main(int argc, char* argv[]) {
  ...
  for (int m = 1; m < argc; ++m) {
    ...
    if (arg == "-o")
      ...
      std::cerr
	<< "Usage: RandomPermutation [-o] [-d] [-x] [-v] [-h] [num]\n\
\n\
...
output base (default decimal). -v prints seed on standard\n\
error. -h prints this help.\n";
      return 0;
    }
    else {
