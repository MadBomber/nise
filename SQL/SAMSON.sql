...
--
-- Host: localhost
-- Generation Time: Aug 12, 2008 at 12:39 PM
...
--
DROP DATABASE IF EXISTS `ModelsAndServices`;
...
DROP TABLE IF EXISTS `mDBLogger_SavedPlotDetails`;
...
(37, 19, 1, 'SELECT * FROM `%ISEPORTAL_CURRENT_UUID`.`MessageTruthTargetStates` WHERE entity=2', 5000000, 'pos_x', 'pos_y'),
(36, 19, 0, 'SELECT * FROM `%ISEPORTAL_CURRENT_UUID`.`MessageTruthTargetStates` WHERE entity=1', 5000000, 'pos_x', 'pos_y'),
(35, 18, 0, 'SELECT * FROM `%ISEPORTAL_CURRENT_UUID`.`MessageTruthTargetStates`', 5000000, 'pos_x', 'pos_y'),
(29, 15, 0, 'SELECT * FROM `%ISEPORTAL_CURRENT_UUID`.`MessageTruthTargetStates` WHERE entity=1 AND time % 5 < .0001', 500000, 'time', 'pos_x'),
(30, 15, 1, 'SELECT * FROM `%ISEPORTAL_CURRENT_UUID`.`MessageMissileDownlink` WHERE entity=1 AND time % 5 < 0.0001', 500000, 'time', 'pos_x'),
(31, 16, 0, 'SELECT * FROM `%ISEPORTAL_CURRENT_UUID`.`MessageTruthTargetStates` WHERE entity=2 AND time % 5 < .0001', 500000, 'time', 'pos_x'),
(32, 16, 1, 'SELECT * FROM `%ISEPORTAL_CURRENT_UUID`.`MessageMissileDownlink` WHERE entity=2 AND time % 5 < 0.0001', 500000, 'time', 'pos_x'),
(33, 17, 0, 'SELECT * FROM `%ISEPORTAL_CURRENT_UUID`.`MessageTruthTargetStates` WHERE entity=3 AND time % 5 < .0001', 500000, 'time', 'pos_x'),
(34, 17, 1, 'SELECT * FROM `%ISEPORTAL_CURRENT_UUID`.`MessageMissileDownlink` WHERE entity=3 AND time % 5 < 0.0001', 500000, 'time', 'pos_x');
...
DROP TABLE IF EXISTS `mDBLogger_SavedPlots`;
...
(68, 'AdvanceTime', 'Advance Time', NULL, NULL, NULL),
(72, 'CMDTargetState', 'Target Truth', NULL, NULL, NULL),
(71, 'TimeAdvanced', 'Advance Time', NULL, NULL, NULL);
...
DROP TABLE IF EXISTS `DispatcherEntity2Models`;
...
CREATE TABLE IF NOT EXISTS `Job` (
  ...
  `LastModDate` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP,
  `InputDir` varchar(256) default NULL,
  `OutDir` varchar(512) default NULL,
  PRIMARY KEY  (`ID`),
  UNIQUE KEY `UUID` (`UUID`),
  KEY `Name` (`Name`,`Status`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='List of Active Jobs' AUTO_INCREMENT=1 ;
...
DROP TABLE IF EXISTS `JobProcesses`;
CREATE TABLE IF NOT EXISTS `JobProcesses` (
  ...
  `LogState` int(11) NOT NULL default '0',
...
DROP TABLE IF EXISTS `MASES_Stub`;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Registered Messages for a given Model' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `Model` (
  ...
  `ExecuteTime` double NOT NULL,
  PRIMARY KEY  (`ID`),
  KEY `JobID` (`JobID`,`DLL`,`UnitID`),
  KEY `DispNodeID` (`DispNodeID`),
  KEY `ID` (`ID`,`UnitID`),
  KEY `ID_2` (`ID`,`UnitID`,`DispNodeID`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `Node` (
  ...
  KEY `FQDN` (`FQDN`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='Contains a list of registered peers on this Samson Network' AUTO_INCREMENT=26 ;

--
-- Dumping data for table `Node`
--

INSERT INTO `Node` (`ID`, `Name`, `Description`, `IPAddress`, `Status`, `FQDN`) VALUES
(22, 'pcig22', NULL, '138.209.52.137', 0, 'pcig22.lmmfc-vrsil.com'),
(32, 'pcig32', 'IseQueen_Test', '138.209.52.147', 0, 'pcig32.lmmfc-vrsil.com'),
(33, 'pcig33', 'IseQueen_Development_Dewayne', '138.209.52.148', 0, 'pcig33.lmmfc-vrsil.com'),
(29, 'pcig29', 'The 29 machine has been smoked; it is perminately off-line.', '138.209.52.144', 0, 'pcig29.lmmfc-vrsil.com'),
(28, 'pcig28', NULL, '138.209.52.143', 0, 'pcig28.lmmfc-vrsil.com'),
(26, 'pcig26', NULL, '138.209.52.141', 0, 'pcig26.lmmfc-vrsil.com'),
(24, 'pcig24', NULL, '138.209.52.139', 0, 'pcig24.lmmfc-vrsil.com'),
(23, 'pcig23', NULL, '138.209.52.138', 0, 'pcig23.lmmfc-vrsil.com'),
(31, 'pcig31', 'IseQueen_Production', '138.209.52.146', 0, 'pcig31.lmmfc-vrsil.com');
...
CREATE TABLE IF NOT EXISTS `Peer` (
  ...
  KEY `NodeID` (`NodeID`),
  KEY `PeerKey` (`PeerKey`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=16045 ;
...
INSERT INTO `RegisteredJobConfig` (`ID`, `DLL`, `Name`, `NumOfEntities`, `Extra`, `External`, `LogState`, `SortOrder`) VALUES
(1, 'Executive', 'EXEC', '1', '-n3', 0, 0, 2),
(1, 'Launcher', 'Lnchr', '1', '', 0, 0, 3),
(1, 'Missile', 'Missile', '3', '', 0, 0, 4),
(1, 'SamsonAppController', 'Ctrlr', '1', '-m1', 0, 0, 1),
(1, 'Sr', 'SrvRdr', '1', '', 0, 1, 5),
(1, 'TargetModel', 'Target', '3', '', 0, 0, 6),
(1, 'TOC', 'TOC', '1', '', 0, 0, 7),
(1, 'VatLogData', 'VAT', '1', '', 0, 0, 8),
(1, 'DBLogger', 'DBLog', '1', '', 0, 0, 10),
(1, 'TrkRadar', 'TrkRadar', '1', NULL, 0, 0, 9),
(2, 'Executive', 'EXEC', '1', '-n3', 0, 0, 2),
(2, 'Launcher', 'Lnchr', '1', '', 0, 0, 3),
(2, 'Missile', 'Missile', '3', '', 0, 0, 4),
(2, 'SamsonAppController', 'Ctrlr', '1', '-m1', 0, 0, 1),
(2, 'Sr', 'SrvRdr', '1', '', 0, 0, 5),
(2, 'TargetModel', 'Target', '3', '', 0, 0, 6),
(2, 'TOC', 'TOC', '1', '', 0, 0, 7),
(2, 'VatLogData', 'VAT', '1', '', 0, 0, 8),
(2, 'TrkRadar', 'TrkRadar', '1', NULL, 0, 0, 9),
(2, 'Graphic', 'Graph', '1', NULL, 0, 0, 0),
(3, 'RamThreat', 'Target', '2', '-f "../ISE-Models/RamThreat/config"', 0, 0, 0),
(3, 'SamsonAppController', 'Ctrl', '1', '-m1', 0, 0, 0),
(3, 'Graphic', 'Graph', '1', NULL, 0, 0, 0),
(3, 'Executive', 'Exec', '1', '-n2', 0, 0, 0),
(4, 'Executive', 'EXEC', '1', '-n1', 0, 0, 2),
(4, 'Launcher', 'Lnchr', '1', '', 0, 0, 3),
(4, 'Missile', 'Missile', '1', '', 0, 0, 4),
(4, 'SamsonAppController', 'Ctrlr', '1', '-m1', 0, 0, 1),
(4, 'Sr', 'SrvRdr', '1', '', 0, 0, 5),
(4, 'TargetModel', 'Target', '1', '', 1, 0, 6),
(4, 'TOC', 'TOC', '1', '', 0, 0, 7),
(4, 'TrkRadar', 'TrkRadar', '1', NULL, 0, 0, 9),
(4, 'VatLogData', 'VAT', '1', '', 0, 0, 8),
(5, 'SamsonAppController', 'Ctrlr', '1', '-m1', 0, 0, 1),
(5, 'MASES_stub', 'MASES_IF', '1', '', 0, 0, 9),
(5, 'Traj3DOF', 'Traj3DOF', '2', '', 1, 0, 8),
(6, 'SamsonAppController', 'Ctrlr', '1', '-m1', 0, 0, 1),
(6, 'MASES_stub', 'MASES_IF', '1', NULL, 0, 0, 9),
(6, 'Traj3DOF', 'Traj3DOF', '1', '', 1, 0, 8),
(6, 'Sim6DOF', 'Sim6DOF', '1', '', 1, 0, 8),
(7, 'SamsonAppController', 'Ctrlr', '1', '-m1', 0, 0, 1),
(7, 'DBLogger', 'DBLog', '1', ' ', 0, 0, 3),
(7, 'CMD_Target', 'CMDTarget', '1', '', 0, 0, 6),
(7, 'CMD_Radar', 'CMDRadar', '1', '', 0, 0, 4),
(7, 'CMD_Missile', 'CMDMissile', '1', '', 0, 0, 5),
(8, 'Tater', 'HotPotato', '3', '', 0, 0, 2);
...
DROP TABLE IF EXISTS `RegisteredModel`;
...
DROP TABLE IF EXISTS `RegisteredPeer`;
...
DROP TABLE IF EXISTS `RunStats_Dispatcher`;
...
DROP TABLE IF EXISTS `RunStats_Master`;
...
DROP TABLE IF EXISTS `ServiceRandomNumber`;
