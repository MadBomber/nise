#########################################################
###
##  File:  ruby_message_logger.rb
##  Desc:  Print message content to a text file
#
...
# <=- Add ruby_message_logger global library requirements here
#     The library files that are specific to ruby_message_logger
...
begin
  ...
  $model_record.name  = 'RubyMessageLogger'
...
module RubyMessageLogger
  ...
  ###############################################################
  ## Register ruby_message_logger with the IseDatabase
  ...
  ## specific to ruby_message_logger have been loaded.
...
end ## end of module RubyMessageLogger
