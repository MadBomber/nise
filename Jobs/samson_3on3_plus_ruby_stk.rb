...
#############################################################################
###
##  Name:   Samson_3on3_olus_ruby_stk.rb
##
...
if Job.find_by_name("samson_3on3_plus_ruby_stk")
  ...
  samson_3on3 = IseJob.replace(       # Note use of parens to enclose the parameters
      "samson_3on3_plus_ruby_stk") # Some short meaningful name

else

  samson_3on3 = IseJob.new(                           # Note use of parens to encolse the parameters
      "samson_3on3_plus_ruby_stk",                 # Some short meaningful name
      "SamsonSimulation 3 on 3 + RubyStkTrackInsert")  # Single line description,
...
samson_3on3.output_dir = "output/samson_3on3_plus_ruby_stk" # default output directory for this IseJob


# Now define some IseModels to be part of this IseJob....

##########################################################
ruby_stk_track_insert = IseModel.new(
  "ruby_stk_track_insert",
  "Ruby-based generic message logger",
  "any",
  "ruby_stk_track_insert"
)

ruby_stk_track_insert.cmd_line_param = "--stk 138.209.69.248:5001"

samson_3on3.add(ruby_stk_track_insert)
