...
#############################################################################
###
##  Name:   Samson_3on3_olus_ruby_logger.rb
##
...
samson_3on3 = IseJob.init(                          # Note use of parens to encolse the parameters
    "samson_3on3_plus_ruby_logger",                 # Some short meaningful name
    "SamsonSimulation 3 on 3 + RubyMessageLogger")  # Single line description,


# Establish the default IseRouter to use for this IseJob
samson_3on3.router = :dispatcher
...
samson_3on3.output_dir = "output/samson_3on3_plus_ruby_logger" # default output directory for this IseJob
...
ruby_message_logger.required = false    # This model is not required for an IseRun

# Setup which messages to log from which IseRouter
ruby_message_logger.cmd_line_param = "--dispatcher -m TruthTargetStates"

samson_3on3.add(ruby_message_logger)


=begin
# Removed executive with new end_engagement protocol
##########################################################
executive_model = IseModel.new(
    "Executive",                            # name of the IseModel
...
samsonappcontroller_model.cmd_line_param="-m1"
