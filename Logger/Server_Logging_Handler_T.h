...
/**
 * @class ISE_Server_Logging_Handler_T
 *
 * @brief Product object created by an <ISE_Server_Logging_Acceptor_T>.  An
 * <ISE_Server_Logging_Handler_T> receives, and frames logging
...
class ISE_Server_Logging_Handler_T : public ACE_Svc_Handler<ACE_PEER_STREAM_2, ACE_SYNCH_USE>
{
public:
  /// Constructor.
  ISE_Server_Logging_Handler_T (ACE_Thread_Manager *,
...
/**
 * @class ISE_Server_Logging_Acceptor_T
 *
...
class ISE_Server_Logging_Acceptor_T : public ACE_Strategy_Acceptor<SERVER_LOGGING_HANDLER, LOGGING_PEER_ACCEPTOR>
{
public:
  /// Dynamic linking hook.
  ISE_Server_Logging_Acceptor_T (void);
...
private:
  // At the moment each ISE_Server_Logging_Acceptor_T contains
...
/**
 * @class ISE_Server_Logging_Handler
 *
 * @brief Product object created by a
 * <ISE_Server_Logging_Acceptor_T<ISE_Server_Logging_Handler> >.  An
 * <ISE_Server_Logging_Handler> receives, frames. The logging record
...
class ISE_Server_Logging_Handler : public ISE_Server_Logging_Handler_T<LOGGING_PEER_STREAM, u_long, ACE_NULL_SYNCH, LOG_MESSAGE_RECEIVER>
{

public:
  ISE_Server_Logging_Handler (ACE_Thread_Manager * = 0);
  ISE_Server_Logging_Handler (ACE_Thread_Manager *,
                              const LOG_MESSAGE_RECEIVER &receiver);
 ...
 *
 * @brief Product object created by a
 * <ISE_Server_Logging_Acceptor_T<ACE_Thr_Server_Logging_Handler>
 * >.  An <ISE_Thr_Server_Logging_Handler> receives, frames. The
 * logging record is then processed by the <LOG_MESSAGE_RECEIVER>
 *
 * Each client is handled in its own separate thread.
 */
template<class LOG_MESSAGE_RECEIVER>
class ISE_Thr_Server_Logging_Handler : public ISE_Server_Logging_Handler_T<LOGGING_PEER_STREAM, ACE_LOGGER_COUNTER, ACE_LOGGER_SYNCH, LOG_MESSAGE_RECEIVER>
{

public:
  ISE_Thr_Server_Logging_Handler (ACE_Thread_Manager * = 0);
  ISE_Thr_Server_Logging_Handler (ACE_Thread_Manager *,
                                  const LOG_MESSAGE_RECEIVER &receiver);
  virtual int open (void * = 0);
