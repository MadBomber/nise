...
typedef ISE_Server_Logging_Handler<Null_Synch_Static_Receiver>
        Null_Synch_Logging_Handler_Static_Receiver;

// synched logging handlers
typedef ISE_Server_Logging_Handler<Synch_Static_Receiver>
        Synch_Logging_Handler_Static_Receiver;
typedef ISE_Thr_Server_Logging_Handler<Synch_Static_Receiver>
        Synch_Thr_Logging_Handler_Static_Receiver;

// NULL synched logging acceptor
typedef ISE_Server_Logging_Acceptor_T<Null_Synch_Logging_Handler_Static_Receiver,
                                      Null_Synch_Static_Receiver,
...
typedef ISE_Server_Logging_Acceptor_T<Synch_Logging_Handler_Static_Receiver,
                                      Synch_Static_Receiver,
                                      ACE_Schedule_All_Reactive_Strategy<Synch_Logging_Handler_Static_Receiver> >
        Synch_Logging_Handler_Static_Receiver_Acceptor;

typedef ISE_Server_Logging_Acceptor_T<Synch_Thr_Logging_Handler_Static_Receiver,
                                      Synch_Static_Receiver,
...
// synched logging handlers
typedef ISE_Server_Logging_Handler<Synch_Receiver>
        Synch_Logging_Handler_Receiver;
typedef ISE_Thr_Server_Logging_Handler<Synch_Receiver>
        Synch_Thr_Logging_Handler_Receiver;

// synched logging acceptors
typedef ISE_Server_Logging_Acceptor_T<Synch_Logging_Handler_Receiver,
                                      Synch_Receiver,
                                      ACE_Schedule_All_Reactive_Strategy<Synch_Logging_Handler_Receiver> >
        Synch_Logging_Handler_Receiver_Acceptor;

typedef ISE_Server_Logging_Acceptor_T<Synch_Thr_Logging_Handler_Receiver,
                                      Synch_Receiver,
...
typedef Null_Synch_Logging_Handler_Static_Receiver_Acceptor
        ISE_Server_Logging_Acceptor;
typedef Synch_Thr_Logging_Handler_Static_Receiver_Acceptor
        ISE_Thr_Server_Logging_Acceptor;

ACE_SVC_FACTORY_DECLARE (ISE_Server_Logging_Acceptor)
ACE_SVC_FACTORY_DECLARE (ISE_Thr_Server_Logging_Acceptor)
