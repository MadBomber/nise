 ...
 *
 *  $Id: Client_Logging_Handler.h 1140 2009-07-21 18:40:01Z lavender $
 *
...
#ifndef ISE_CLIENT_LOGGER_H
#define ISE_CLIENT_LOGGER_H
 ...
 */
class ACE_Svc_Export ISE_Client_Logging_Handler : public ACE_Svc_Handler<LOGGING_STREAM, ACE_NULL_SYNCH>
{
...
public:
  ...
  ISE_Client_Logging_Handler (ACE_HANDLE handle = ACE_STDERR);
...
ACE_SVC_FACTORY_DECLARE (ISE_Client_Logging_Acceptor)

#endif /* ISE_CLIENT_LOGGER_H */
